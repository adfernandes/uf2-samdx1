...
void system_init(void) {
   ...
   *   ignoring the selected generic clock reference.
   *   When the USB device is connected, a SOF will be sent every 1ms,
   *   thus DFLLVAL.MUX bits should be written to 0xBB80 (48000) to obtain a 48MHz clock.
   */

  // open-loop mode temperarily
